...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="根据数据目录导出多地区、多因子前端数据。")
    parser.add_argument("--catalog", type=Path, default=Path("config/data_catalog.json"))
    parser.add_argument("--output", type=Path, default=Path("web/data/dataset.js"))
